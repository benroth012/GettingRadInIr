            ...
            <div className="App">
                ...
                <Row style={{ margin: `10px` }}>
                    ...
                    <Col sm={4} style={{ marginBottom: `20px` }}>
                        ...
                        <Card.Header style={{ textAlign: `right`}}><Button variant="danger" style={{ paddingLeft: `10px`, paddingRight: `10px`}} onClick={() => this.deleteEducation(item.id)}>x</Button></Card.Header>
                        <Card.Img variant="top" src={item.icon} style={{ width: 'auto', maxWidth: '90%', objectFit: 'contain', marginTop: `40px`, display: 'block', marginLeft: `auto`, marginRight: `auto`, height: '520px' }} />
                        <Card.Body>
                            <Card.Title style={{ fontWeight: `500` }}>{item.name}</Card.Title>
                        </Card.Body>
                        <Button onClick={() => this.handlePDFs(item.name)} variant="primary" className="App-button" style={{ paddingLeft: `50px`, paddingRight: `50px`, height: '20%', marginBottom: '5px' }}>Learn More</Button>
                        </Card>
                    </Col>
                    )}
                </Row>
                ...
                <div style={{ paddingTop: '10px' }}>
                    <Button variant="success" style={{ paddingLeft: `40px`, paddingRight: `40px`}} onClick={() => this.handleModalShowHide()}>Add New Card</Button>
                </div>
                <Modal
                size="lg"
                ...
                >
                    ...
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Modal.Footer>
                            ...
                            <Button onClick={() => this.handleModalShowHide()} variant="success" type="submit">Submit</Button>
                        </Modal.Footer>
                    </Form>
                </Modal>
            </div>
                ...
                <Tab.Container id="list-group-tabs-example" defaultActiveKey="#0">
                    ...
                    <Col sm={8}>
                        ...
                        {pdfLinks.map((link, index) =>
                            ...
                            <iframe src={'https://drive.google.com/viewerng/viewer?url=' + link + '?pid=explorer&efh=false&a=v&chrome=false&embedded=true'} width="90%" height="1400px" />
                            </Tab.Pane>
                        )}
                        </Tab.Content>
                    </Col>
