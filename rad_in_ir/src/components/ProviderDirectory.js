...
import { Jumbotron, Card, CardGroup, Col, Row } from 'react-bootstrap';
import '../App.css';
    ...
    return (
      ...
      <div>
        ...
        <Jumbotron className="jumbotron-special roboto white-text" style={{ backgroundImage: `url(${bgimage})`, backgroundSize: `cover`, backgroundPosition: `center top`, height: `10%` }}>
          ...
          <p style={{ fontSize: `1.5em` }}>Below are the names of the Interventional Radiology physicians and advanced practice providers.</p>
        </Jumbotron>
