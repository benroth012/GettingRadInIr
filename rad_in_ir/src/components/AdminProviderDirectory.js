        ...
        return (
            <div>
                ...
                <Button variant="success" style={{paddingLeft: `40px`, paddingRight: `40px`}}
                        onClick={() => this.handlePhysicianModalShowHide()}>Add New Physician</Button>
                <Modal
                    size="lg"
                    ...
                    <Form onSubmit={this.handlePhysicianSubmit}>
                        <Modal.Body>
                            <Form.Group controlId="formName">
                                ...
                                <Form.Control type="name" placeholder="Enter Physician Name"
                                              onChange={this.physicianNameHandler}/>
                            ...
                            <Form.Group controlId="formLink">
                                ...
                                <Form.Control type="link" placeholder="Enter Physician Link"
                                              onChange={this.physicianLinkHandler}/>
                            </Form.Group>
                            <Form.Group controlId="formImage">
                                <Form.Label>Upload Physician Image</Form.Label>
                                <input type="file" onChange={this.physicianImageHandler}
                                       style={{paddingLeft: '40px'}}></input>
                            </Form.Group>
                        </Modal.Body>
                        <Modal.Footer>
                            <Button onClick={() => this.handlePhysicianModalShowHide()}
                                    variant="warning">Cancel</Button>
                            <Button onClick={() => this.handlePhysicianModalShowHide()} variant="success"
                ...
                <Button variant="success" style={{paddingLeft: `40px`, paddingRight: `40px`}}
                        onClick={() => this.handleProviderModalShowHide()}>Add New Provider</Button>
                <Modal
                    size="lg"
                    aria-labelledby="contained-modal-title-vcenter"
                    centered
                    ...
                    <Form onSubmit={this.handleProviderSubmit}>
                        <Modal.Body>
                            <Form.Group controlId="formName">
                                ...
                                <Form.Control type="name" placeholder="Enter Physician Name"
                                              onChange={this.providerNameHandler}/>
                                <Form.Text className="text-muted">
                            ...
                            <Form.Group controlId="formImage">
                                ...
                                <input type="file" onChange={this.providerImageHandler}
                                       style={{paddingLeft: '40px'}}></input>
                            </Form.Group>
                        </Modal.Body>
                        <Modal.Footer>
                            <Button onClick={() => this.handleProviderModalShowHide()} variant="warning">Cancel</Button>
                            <Button onClick={() => this.handleProviderModalShowHide()} variant="success"
                                    type="submit">Submit</Button>
                        </Modal.Footer>
                    </Form>
                </Modal>
